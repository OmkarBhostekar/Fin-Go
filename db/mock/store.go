...
func (m *MockStore) CreateSession(arg0 context.Context, arg1 simplebank.CreateSessionParams) (simplebank.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSession", arg0, arg1)
	ret0, _ := ret[0].(simplebank.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 simplebank.CreateUserParams) (simplebank.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateUserTx(arg0 context.Context, arg1 simplebank.CreateUserTxParams) (simplebank.CreateUserTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUserTx", arg0, arg1)
	ret0, _ := ret[0].(simplebank.CreateUserTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateVerifyEmail(arg0 context.Context, arg1 simplebank.CreateVerifyEmailParams) (simplebank.VerifyEmail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateVerifyEmail", arg0, arg1)
	ret0, _ := ret[0].(simplebank.VerifyEmail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetSession(arg0 context.Context, arg1 uuid.UUID) (simplebank.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUserByUsername(arg0 context.Context, arg1 string) (simplebank.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateUser(arg0 context.Context, arg1 simplebank.UpdateUserParams) (simplebank.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateVerifyEmail(arg0 context.Context, arg1 simplebank.UpdateVerifyEmailParams) (simplebank.VerifyEmail, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) VerifyEmailTx(arg0 context.Context, arg1 simplebank.VerifyEmailTxParams) (simplebank.VerifyEmailTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyEmailTx", arg0, arg1)
	ret0, _ := ret[0].(simplebank.VerifyEmailTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
